// ./src/components/Dashboard/BusinessByLocation.js
...
export class BusinessByLocation extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { businessLocation: this.props.match.params.location };
    }

    componentWillReceiveProps(nextProps) {
        this.setState({ businessLocation: nextProps.match.params.location });
    }
    ...
    // renders JSX content
    render() {
        const filteredBusinesses = this.props.businesses.filter(business => business.location === this.state.businessLocation);
            ...
            <div className="page-wrapper">
                ...
                <main className="main-body">
                    <div className="container-fluid">
                        ...
                        <DashboardTitle title={this.state.businessLocation}/>
...
export default connect(mapStateToProps, mapDispatchToProps)(BusinessByLocation);
